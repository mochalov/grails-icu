...
/**
 * ICU4j MessageFormat aware {@link org.codehaus.groovy.grails.context.support.PluginAwareResourceBundleMessageSource}
 * drop-in
...
public class ICUPluginAwareResourceBundleMessageSource extends ICUReloadableResourceBundleMessageSource implements GrailsApplicationAware, PluginManagerAware, InitializingBean {
    private static final Log LOG = LogFactory.getLog(ICUPluginAwareResourceBundleMessageSource.class);
